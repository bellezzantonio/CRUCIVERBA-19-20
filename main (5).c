...
struct suggerimenti_v{
  ...
  struct suggerimenti_v *next;
    ...
    void stampa_griglia_o(struct risposte_utente_o *testa, struct risposte_utente_v *head){
    struct risposte_utente_o *r_u_o;
    r_u_o=testa;
    struct risposte_utente_v *r_u_v;
    r_u_v=head;
    ...
    griglia[1][8]='O';
    griglia[2][4]='O';
    griglia[3][2]='O'; griglia[3][7]='O';
    griglia[4][7]='O';
    griglia[5][3]='O'; griglia[5][6]='O';
    griglia[7][3]='O'; griglia[7][5]='O';
    griglia[8][6]='O';
    griglia[9][2]='O'; griglia[9][8]='O';
             
              while(r_u_o!=NULL){
                a=r_u_o->num_risposta;
                strcpy(griglia[a],r_u_o->risposta);
                r_u_o=r_u_o->next;
              }
